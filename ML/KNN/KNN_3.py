...
def main():
    ...
    # Identify stocks with negative or zero returns in the best cluster
    stocks_with_negative_or_zero_return = best_cluster_stocks[best_cluster_stocks['AverageReturn'] <= 0]['Stock'].tolist()
    print("\nStocks with Negative or Zero Returns in the Best Cluster:")
    print(stocks_with_negative_or_zero_return)
