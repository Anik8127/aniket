...
class KALTNERCHANNEL(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "KALTNERCHANNEL":
...
if __name__ == "__main__":
    ...
    algoLogicObj = KALTNERCHANNEL(devName, strategyName, version)
