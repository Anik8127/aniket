...
# Load the CSV file
file_path = "/root/aniket/Research/straddle_arbitrage/25-02-2025/nifty/combined_premium.csv"
...
for column in columns_to_plot:
    ...
    output_file = f"/root/aniket/Research/straddle_arbitrage/25-02-2025/nifty/plots/{column}_interactive_plot.html"
