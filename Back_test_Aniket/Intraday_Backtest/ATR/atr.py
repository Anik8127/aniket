...
class algoLogic(optOverNightAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        df_5min['Entryatr'] = np.where(df_5min['atr'] > 25, "Entryatr", "")
        ...
        for timeData in df.index: 
            ...
            if (timeData-300) in df_5min.index:
                self.strategyLogger.info(f"Datetime: {self.humanTime}\tClose: {df.at[lastIndexTimeData[1],'c']}\tHigh: {df.at[lastIndexTimeData[1],'h']}\tLow: {df.at[lastIndexTimeData[1],'l']}\tatr: {df_5min.at[last5MinIndexTimeData[1],'atr']}")
            ...
            if ((timeData-300) in df_5min.index) and self.openPnl.empty:
                ...
                if df_5min.at[last5MinIndexTimeData[1], "Entryatr"] == "Entryatr":
