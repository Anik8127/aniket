...
# Load the CSV file
file_path = "/root/aniket/Research/straddle_arbitrage/24-04-2025/sensex/combined_premium.csv"
...
for column in columns_to_plot:
    ...
    output_file = f"/root/aniket/Research/straddle_arbitrage/24-04-2025/sensex/plots/{column}_interactive_plot.html"
