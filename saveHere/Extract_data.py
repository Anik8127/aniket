...
class algoLogic(optOverNightAlgoLogic):
    ...
    def run(self, startDate, endDate, baseSym, indexSym):
        ...
        #     if (timeData-300) in df_5min.index:
        #         self.strategyLogger.info(f"Datetime: {self.humanTime}\tClose: {df.at[lastIndexTimeData[1],'c']}\tadx: {df_5min.at[last5MinIndexTimeData[1],'adx']}\tmacd: {df_5min.at[last5MinIndexTimeData[1],'macd']}\tmacdsignal: {df_5min.at[last5MinIndexTimeData[1],'macdsignal']}")
        ...
        #         if df_5min.at[last5MinIndexTimeData[1], "EntryADX"] == "EntryADX" and df_5min.at[last5MinIndexTimeData[1], "macdBearish"] == "macdBearish":
        ...
        #         if df_5min.at[last5MinIndexTimeData[1], "EntryADX"] == "EntryADX" and df_5min.at[last5MinIndexTimeData[1], "macdBullish"] == "macdBullish":
...
if __name__ == "__main__":
    ...
    startDate = datetime(2023, 1, 3, 9, 15)
    endDate = datetime(2024, 12, 12, 15, 30)
